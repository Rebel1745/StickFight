...
public class E_Zombie_PlayerDetectedState : Enemy_PlayerDetectedState
{
    ...
    public E_Zombie_PlayerDetectedState(Enemy enemy, EnemyStateMachine stateMachine, string animBoolName, D_PlayerDetectedStateData stateData, E_Zombie e_Zombie) : base(enemy, stateMachine, animBoolName, stateData)
    {
        _e_Zombie = e_Zombie;
    }
